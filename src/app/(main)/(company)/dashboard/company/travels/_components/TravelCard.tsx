  ...
  return (
    <Card className="group relative overflow-hidden border border-slate-200 bg-white hover:shadow-2xl hover:border-slate-300 transition-all duration-300">
      ...
      <div className="relative h-56 overflow-hidden">
        <Image src={travel.coverImage!} alt={travel.name} fill className="object-cover group-hover:scale-110 transition-transform duration-500" />
      ...
      <CardContent className="space-y-4 p-4 pt-0">
        <div className="flex gap-4">
          <div className="flex items-center gap-2.5 text-sm text-slate-700 flex-1">
