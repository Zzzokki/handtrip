      ...
      {totalPages > 1 && (
        <div className="mt-4 flex items-center justify-between">
          <div className="text-sm text-muted-foreground">
            Нийт {filteredAndSortedCustomers.length} хэрэглэгчээс {(currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredAndSortedCustomers.length)} харуулж байна
          </div>
          <div className="flex items-center gap-2">
