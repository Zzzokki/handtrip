      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">HandTrip</span>
            </div>
            <p className="text-sm mb-4">Аялал жуулчлалыг хялбар, дурсамжтай болгож байна.</p>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">Судлах</h4>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">© {currentYear} HandTrip. Бүх эрх хуулиар хамгаалагдсан.</p>
