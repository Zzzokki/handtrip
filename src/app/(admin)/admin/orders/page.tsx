      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between mt-4">
          <div className="text-sm text-muted-foreground">
            {filteredAndSortedOrders.length} захиалгын {(currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredAndSortedOrders.length)}-ийг үзүүлж байна
          </div>
          <div className="flex items-center gap-2">
