        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl shadow-sm p-6 text-white">
            ...
            <p className="text-blue-100 mb-4">
              You have 5 pending booking requests waiting for your approval.
            </p>
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">John Doe booked "Mountain Adventure"</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">"Coastal Escape" tour finished successfully</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">5-star review on "City Explorer"</p>
                </div>
              </div>
